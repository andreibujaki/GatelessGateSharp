...
namespace ATI.ADL
{
    ...
    internal delegate int ADL2_Overdrive6_ThermalLimitUnlock_Set(IntPtr context, int iAdapterIndex, int iStateType, int iEnable);
    ...
    internal static class ADL
    {
        ...
        private static class ADLImport
        {
            ...
            [DllImport(Atiadlxx_FileName)]
            internal static extern int ADL2_Overdrive6_ThermalLimitUnlock_Set(IntPtr context, int iAdapterIndex, int iStateType, int iEnable);
        ...
        #region ADL2_Overdrive6_ThermalLimitUnlock_Set
        /// <summary> ADL2_Overdrive6_ThermalLimitUnlock_Set Delegates</summary>
        internal static ADL2_Overdrive6_ThermalLimitUnlock_Set ADL2_Overdrive6_ThermalLimitUnlock_Set {
            get {
                if (!ADL2_Overdrive6_ThermalLimitUnlock_Set_Check && null == ADL2_Overdrive6_ThermalLimitUnlock_Set_) {
                    ADL2_Overdrive6_ThermalLimitUnlock_Set_Check = true;
                    if (ADLCheckLibrary.IsFunctionValid("ADL2_Overdrive6_ThermalLimitUnlock_Set")) {
                        ADL2_Overdrive6_ThermalLimitUnlock_Set_ = ADLImport.ADL2_Overdrive6_ThermalLimitUnlock_Set;
                    }
                }
                return ADL2_Overdrive6_ThermalLimitUnlock_Set_;
            }
        }
        /// <summary> Private Delegate</summary>
        private static ADL2_Overdrive6_ThermalLimitUnlock_Set ADL2_Overdrive6_ThermalLimitUnlock_Set_ = null;
        /// <summary> check flag to indicate the delegate has been checked</summary>
        private static bool ADL2_Overdrive6_ThermalLimitUnlock_Set_Check = false;
        #endregion ADL2_Overdrive6_ThermalLimitUnlock_Set
