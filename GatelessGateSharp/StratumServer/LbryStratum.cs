...
{
    class LbryStratum : StratumServer
    {
        ...
        public LbryStratum(String aServerAddress, int aServerPort, String aUsername, String aPassword, String aPoolName, bool aSecureConnection = false)
            : base(aServerAddress, aServerPort, aUsername, aPassword, aPoolName, "lbry", aSecureConnection)
        {
        }
    }
}
