...
{
    class NeoScryptStratum : StratumServer
    {
        ...
        public new class Job : StratumServer.Job
        {
            ...
            private NeoScryptStratum mStratum;
            ...
            public new NeoScryptStratum Stratum { get { return mStratum; } }
        ...
        public NeoScryptStratum(String aServerAddress, int aServerPort, String aUsername, String aPassword, String aPoolName, bool aSecureConnection = false)
            : base(aServerAddress, aServerPort, aUsername, aPassword, aPoolName, "neoscrypt", aSecureConnection)
        {
        }
    }
}
