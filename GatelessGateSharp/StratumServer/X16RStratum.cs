...
{
    class X16RStratum : StratumServer
    {
        ...
        public new class Job : StratumServer.Job
        {
            ...
            public new X16RStratum Stratum { get { return mStratum; } }

            public Job(X16RStratum aStratum, string aID, string aPrevHash, string aCoinbase1, string aCoinbase2, string[] aMerkles, string aVersion, string aNBits, string aNTime)
                : base(aStratum) {
                mStratum = aStratum;
                mID = aID;
                mPrevHash = aPrevHash;
        ...
        public void Submit(OpenCLDevice aDevice, X16RStratum.Work work, UInt32 aNonce)
        {
            if (Stopped)
                return;
        ...
        public X16RStratum(String aServerAddress, int aServerPort, String aUsername, String aPassword, String aPoolName, bool aSecureConnection = false)
            : base(aServerAddress, aServerPort, aUsername, aPassword, aPoolName, "x16r", aSecureConnection)
        {
        }
    }
}
