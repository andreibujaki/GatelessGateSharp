...
namespace GatelessGateSharp
{
    class LbryStratum : Stratum
    {
            ...
            public byte[] Blob
            {
                get
                {
                    ...
                    byte[] coinbase = Utilities.StringToByteArray(Job.Coinbase1
                        ...
                        + ((Job.Stratum.LocalExtranonceSize == 1) ? "" : (Job.Stratum.LocalExtranonceSize == 2) ? "00" : (Job.Stratum.LocalExtranonceSize == 3) ? "0000" : "000000")
                        + Utilities.ByteArrayToString(new byte[] { LocalExtranonce }) 
                        + Job.Coinbase2);
        ...
        protected override void Authorize()
        {
            ...
            mLocalExtranonceSize = (int)(((JArray)(response["result"]))[2]);
            ...
            try
            {
                ...
                String message = JsonConvert.SerializeObject(new Dictionary<string, Object> {
                    ...
                    { "params", new List<string> {
                        Username,
                        work.Job.ID,
                        String.Format((LocalExtranonceSize == 1) ? "{0:x2}" : (LocalExtranonceSize == 2) ? "00{0:x2}" : (LocalExtranonceSize == 3) ? "0000{0:x2}" : "000000{0:x2}", work.LocalExtranonce),
                        work.Job.NTime,
                        stringNonce
                }}});
                WriteLine(message);
