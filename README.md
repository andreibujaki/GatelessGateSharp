...
* [Gateless_Gate_Sharp_1.2.6_alpha_Setup.msi](https://github.com/zawawawa/GatelessGateSharp/releases/download/v1.2.6-alpha/Gateless_Gate_Sharp_1.2.6_alpha_Setup.msi) (Windows x64 Installer; highly recommended)
* [Gateless_Gate_Sharp_1.2.6_alpha.7z](https://github.com/zawawawa/GatelessGateSharp/releases/download/v1.2.6-alpha/Gateless_Gate_Sharp_1.2.6_alpha.7z)
* [Gateless_Gate_Sharp_1.2.6_alpha.zip](https://github.com/zawawawa/GatelessGateSharp/releases/download/v1.2.6-alpha/Gateless_Gate_Sharp_1.2.6_alpha.zip)
