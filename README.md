...
* [Gateless_Gate_Sharp_1.2.7_alpha_Setup.msi](https://github.com/zawawawa/GatelessGateSharp/releases/download/v1.2.7-alpha/Gateless_Gate_Sharp_1.2.7_alpha_Setup.msi) (Windows x64 Installer; highly recommended)
* [Gateless_Gate_Sharp_1.2.7_alpha.7z](https://github.com/zawawawa/GatelessGateSharp/releases/download/v1.2.7-alpha/Gateless_Gate_Sharp_1.2.7_alpha.7z)
* [Gateless_Gate_Sharp_1.2.7_alpha.zip](https://github.com/zawawawa/GatelessGateSharp/releases/download/v1.2.7-alpha/Gateless_Gate_Sharp_1.2.7_alpha.zip)
